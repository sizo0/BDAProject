...
//    Stack<QueryBuilder> cmwheres = new Stack<QueryBuilder>();
          ...
          Stack _elementStack = new Stack();
            ...
            if (!isLegal)
                throw new ParseException(
                  ...
                  public XPath(String xquery)
                  {
//          EXAMPLE
//        String sqlexample = select(field("BOOK.TITLE")).select(field("AUTHOR.FIRST_NAME"), field("AUTHOR.LAST_NAME"))
//                .from(table("BOOK"))
//                .join(table("AUTHOR"))
...
//        System.out.println(sqlexample);
            this(new ByteArrayInputStream(xquery.getBytes(StandardCharsets.UTF_8)));
            // usage
            // this.parse()

                }

  final public Wrapper XPath2() throws ParseException {
                 /*@bgen(jjtree) XPath2 */
    ...
    try {
      ...
      jj_consume_token(0);
                    ...
                    if(this.token_source.curLexState == XPathConstants.EXPR_COMMENT)
                        ...
                        {if (true) return new Wrapper(query, mongodb.DB.INSTANCE.getQuery()) ;}
 ...
 /*@bgen(jjtree) ForClause */
  ...
  mongodb.DB.INSTANCE.initQuery();
  mongodb.DB.INSTANCE.newQuery(document, tablesOrColumns);
      label_9:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 23:
 ...
 /*@bgen(jjtree) WhereClause */
  ...
  jjtree.openNodeScope(jjtn000);
    ...
    System.out.println(mongodb.DB.INSTANCE.getQuery());
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
//                currentWhere = new Where();
                System.out.println("OR " + cwheres.size());
                Condition cwhere1 = cwheres.pop();
                Condition cwhere2 = cwheres.pop();
                String operator = operators.pop();
                cwheres.push(DB.INSTANCE.makeCondition(cwhere1, operator, cwhere2));
//                QueryBuilder cmwhere1 = cmwheres.pop();
//                QueryBuilder cmwhere2 = cmwheres.pop();
//                cmwheres.push(mongodb.DB.INSTANCE.makeCondition(cmwhere1, operator, cmwhere2));
            System.out.println(cwheres);
                System.out.println("/OR " + cwheres.size());
        ...
        jj_consume_token(55);
                if (isWhere) {
                    operators.push("and");
                                ...
                                binaryTokenStack.push(token);
        ComparisonExpr();
                System.out.println("AND " + cwheres.size());
                Condition cwhere1 = cwheres.pop();
                Condition cwhere2 = cwheres.pop();
                String operator = operators.pop();
                cwheres.push(DB.INSTANCE.makeCondition(cwhere1, operator, cwhere2));
...
//                cmwheres.push(mongodb.DB.INSTANCE.makeCondition(cmwhere1, operator, cmwhere2));
 ...
 /*@bgen(jjtree) #PathExpr(> 1) */
  ...
  final public void RelativePathExpr() throws ParseException {
    ...
    while (true) {
      ...
      case Slash:
        jj_consume_token(Slash);
                       afterDocument=isDocument;processToken(((SimpleNode)jjtree.peekNode()), token);
        break;
      case SlashSlash:
        jj_consume_token(SlashSlash);
                                                                                                                      afterDocument=isDocument;
 ...
 /*@bgen(jjtree) #Predicate(> 0) */
  ...
  final public void PrimaryExpr() throws ParseException {
    ...
    if (isWhere) {
    try {
        System.out.println(currentWhere.toSQL());
        cwheres.push(currentWhere.toSQL());
//        cmwheres.push(currentWhere.toMongoDB());
        currentWhere = new Where();
        } catch(Exception e) {
 ...
 afterComparison=false;
  ...
  String value = token.toString();
      ...
      System.out.println(value + " " + isWhere);
  if (isDocument) { document = value;  }
  if (isWhere) { currentWhere.setValue(new Value(value, new StringConvert())); }
                                       SimpleNode jjtn001 = new SimpleNode(this, JJTSTRINGLITERAL);
                                       boolean jjtc001 = true;
                                       jjtree.openNodeScope(jjtn001);
      try {
  ...
  final public void NumericLiteral() throws ParseException {
    ...
    String value = token.toString();
    if (isWhere) currentWhere.setValue(new Value(value, new IntConvert()));
    ...
    value = token.toString();
                                if (isWhere) currentWhere.setValue(new Value(value, new DoubleConvert()));
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      try {
                                                                                                                                                              jjtree.closeNodeScope(jjtn003,  true);
                                                                                                                                                              jjtc003 = false;
                                                                                                                 _elementStack.push(token.image); processToken(jjtn003, token);
      } finally {
                                                                                                                                                              if (jjtc003) {
                                                                                                                                                                jjtree.closeNodeScope(jjtn003,  true);
                                                                                                                                                              }
      ...
      case EmptyTagClose:
        ...
        try {
                                                                                                                                                                                                                                                                                  jjtree.closeNodeScope(jjtn004,  true);
                                                                                                                                                                                                                                                                                  jjtc004 = false;
                                                                                                                                                                                                                     _elementStack.pop(); processToken(jjtn004, token);
        } finally {
                                                                                                                                                                                                                                                                                  if (jjtc004) {
                                                                                                                                                                                                                                                                                    jjtree.closeNodeScope(jjtn004,  true);
                                                                                                                                                                                                                                                                                  }
      ...
      case StartTagClose:
        ...
        try {
                                                                                                                                                                           ...
                                                                                                                                                                           jjtc006 = false;
                                                                                                                                                     if(!token.image.equals(_elementStack.pop())) {if (true) throw new ParseException("Error: In a direct element constructor, the name used in the end tag must exactly match the name used in the corresponding start tag, including its prefix or absence of a prefix. Line: " + token.beginLine);} processToken(jjtn006, token);
        } finally {
                                                                                                                                                                           if (jjtc006) {
                                                                                                                                                                             jjtree.closeNodeScope(jjtn006,  true);
                                                                                                                                                                           }
 ...
 /*@bgen(jjtree) QName */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case QNameToken:
        FunctionQName();
  if (!isStep) { DB.INSTANCE.setCurrentVarTable(token.toString()); mongodb.DB.INSTANCE.setCurrentVar(token.toString()); }
  if (afterDocument) tablesOrColumns.add(token.toString());
    if (isWhere) {
       System.out.println("isWhere: " + currentWhere + " " + isStep + " " + afterComparison + " " + token.toString() + " " + DB.INSTANCE.getAttributeFromVarName());
 String c;
        if ((c = DB.INSTANCE.getAttributeFromVarName()) != null) {
            System.out.println("A: " + currentWhere + " " + isStep + " " + afterComparison + " " + token.toString() + " " + c);
            if (afterComparison && currentWhere.getColumn() != null) {
                ...
                DB.INSTANCE.getTableFromVarName(), c)).toString(), new StringConvert()));
                cwheres.push(currentWhere.toSQL());
                currentWhere = new Where();
            }
            else
             currentWhere.setColumn(new Column(DB.INSTANCE.getTableFromVarName(), c));
        }
      else if (isStep) {
      System.out.println("B: " + currentWhere + " " + afterComparison + " " + token.toString());
        if (afterComparison && currentWhere.getColumn() != null) {
            currentWhere.setFieldTransform(true);
            currentWhere.setValue(new Value((new Column(
    ...
    try {
      ...
      case 104:
        jj_consume_token(104);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 jjtree.closeNodeScope(jjtn000, true);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 jjtc000 = false;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                jjtn000.processValue("document");isDocument=true;
        break;
      case 115:
