...
public class XPath/* @bgen(jjtree) */implements XPathTreeConstants,
		XPathConstants {/* @bgen(jjtree) */
	...
	void processToken(SimpleNode n, Token t) {
		...
		if (t.kind == XPathConstants.Slash
				&& n.id != XPathTreeConstants.JJTSLASH)
			return;

		if (t.kind == XPathConstants.TagQName
				&& n.id != XPathTreeConstants.JJTTAGQNAME)
			return;
		...
		while (numberArgsLeft > 0) {
			try {
				...
				if (args[argsStart].equals("-dumptree")) {
					...
					argsStart++;
					numberArgsLeft--;
					Reader fis = new BufferedReader(new InputStreamReader(
					...
					if (failedList.size() > 0) {
						...
						System.out.println();
						System.out.print("Failed " + failedList.size()
								+ " out of ");
					} else {
					...
					for (int i = argsStart; i < args.length; i++) {
						...
						Reader fis = new BufferedReader(new InputStreamReader(
								new java.io.StringBufferInputStream(args[i]),
								"UTF-8"));
						XPath parser = new XPath(fis);
						SimpleNode tree;
						if (isMatchParser) {
		...
		while (true) {
			try {
				...
				if (null == input || input.trim().length() == 0)
					break;
				XPath parser = new XPath(new BufferedReader(
						new InputStreamReader(
								new java.io.StringBufferInputStream(input),
								"UTF-8")));
				SimpleNode tree;
				if (isMatchParser) {
					tree = parser.XPath2();
	...
	final public void EnclosedExpr() throws ParseException {
		...
		try {
			...
			case LbraceExprEnclosure:
				...
				SimpleNode jjtn002 = new SimpleNode(this,
	...
	final public void IntersectExceptExpr() throws ParseException {
		...
		try {
			...
			label_19: while (true) {
				...
				InstanceofExpr();
				SimpleNode jjtn001 = new SimpleNode(this,
	...
	final public void ValidateExpr() throws ParseException {
		...
		try {
			...
			jj_consume_token(LbraceExprEnclosure);
			SimpleNode jjtn001 = new SimpleNode(this, JJTLBRACEEXPRENCLOSURE);
			boolean jjtc001 = true;
			jjtree.openNodeScope(jjtn001);
			try {
				jjtree.closeNodeScope(jjtn001, true);
	...
	final public void Pragma() throws ParseException {
		...
		try {
			...
			SimpleNode jjtn003 = new SimpleNode(this, JJTQNAMEFORPRAGMA);
			boolean jjtc003 = true;
			jjtree.openNodeScope(jjtn003);
			try {
				jjtree.closeNodeScope(jjtn003, true);
			...
			case SForPragma:
				...
				SimpleNode jjtn004 = new SimpleNode(this, JJTSFORPRAGMA);
				boolean jjtc004 = true;
				jjtree.openNodeScope(jjtn004);
				try {
					jjtree.closeNodeScope(jjtn004, true);
			...
			SimpleNode jjtn005 = new SimpleNode(this, JJTPRAGMACLOSE);
	...
	final public void StepExpr() throws ParseException {
		...
		try {
			if (jj_2_23(3)) {
				FilterExpr();
				jjtree
						.closeNodeScope(jjtn000, jjtree.nodeArity() > 1
								|| isStep);
				jjtc000 = false;
				isStep = savedIsStep;
			} else {
			...
			case StartTagClose:
				...
				try {
					...
					if (!token.image.equals(_elementStack.pop())) {
						if (true)
							throw new ParseException(
									"Error: In a direct element constructor, the name used in the end tag must exactly match the name used in the corresponding start tag, including its prefix or absence of a prefix. Line: "
											+ token.beginLine);
					}
	...
	final public void DirCommentConstructor() throws ParseException {
		...
		try {
			...
			case XmlCommentStartForElementContent:
				...
				SimpleNode jjtn001 = new SimpleNode(this,
						JJTXMLCOMMENTSTARTFORELEMENTCONTENT);
				boolean jjtc001 = true;
				jjtree.openNodeScope(jjtn001);
				try {
					jjtree.closeNodeScope(jjtn001, true);
	...
	final public void DirPIConstructor() throws ParseException {
		...
		try {
			...
			case ProcessingInstructionStartForElementContent:
				...
				SimpleNode jjtn001 = new SimpleNode(this,
						JJTPROCESSINGINSTRUCTIONSTARTFORELEMENTCONTENT);
				boolean jjtc001 = true;
				jjtree.openNodeScope(jjtn001);
				try {
					jjtree.closeNodeScope(jjtn001, true);
			...
			SimpleNode jjtn005 = new SimpleNode(this,
	...
	final public void CDataSection() throws ParseException {
		...
		try {
			...
			case CdataSectionStartForElementContent:
				...
				SimpleNode jjtn001 = new SimpleNode(this,
						JJTCDATASECTIONSTARTFORELEMENTCONTENT);
				boolean jjtc001 = true;
				jjtree.openNodeScope(jjtn001);
				try {
					jjtree.closeNodeScope(jjtn001, true);
	...
	final private boolean jj_3R_280() {
		if (jj_scan_token(StartTagClose))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_279() {
		if (jj_scan_token(EmptyTagClose))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_292() {
		if (jj_scan_token(LbraceExprEnclosure))
			return true;
		if (jj_3R_229())
			return true;
		return false;
	...
	final private boolean jj_3R_285() {
		if (jj_scan_token(ProcessingInstructionStart))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_282() {
		if (jj_scan_token(XmlCommentStart))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_301() {
		if (jj_scan_token(CommentContentCharDash))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_284() {
		if (jj_scan_token(ProcessingInstructionStartForElementContent))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_268() {
		...
		if (jj_scan_token(PITarget))
			return true;
		xsp = jj_scanpos;
		if (jj_3R_286())
			jj_scanpos = xsp;
		if (jj_scan_token(ProcessingInstructionEnd))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_300() {
		if (jj_scan_token(CommentContentChar))
			return true;
		return false;
	}

	final private boolean jj_3R_277() {
		if (jj_scan_token(StartTagOpen))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_281() {
		if (jj_scan_token(XmlCommentStartForElementContent))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_267() {
		...
		if (jj_3R_283())
			return true;
		if (jj_scan_token(XmlCommentEnd))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_239() {
		if (jj_scan_token(DoubleLiteral))
			return true;
		return false;
	}
	...
	final private boolean jj_3R_276() {
		if (jj_scan_token(LessThanOpOrTagO))
			return true;
		return false;
	}
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x2, 0xff7ffe7c, 0xff7ffe7c, 0x10, 0x20000000,
				0x200, 0x20000000, 0x1800, 0xc000, 0xc0000, 0x0, 0x1000800,
				0x6000000, 0x2040, 0x800000, 0x80000000, 0x2040, 0x40,
				0x800000, 0x80000000, 0x0, 0x0, 0x1800, 0x0, 0x0, 0x0,
				0x800000, 0x0, 0x0, 0x800000, 0xff7ffe7c, 0x0, 0x0, 0x0,
				0x100000, 0x0, 0x80000000, 0x800000, 0x0, 0x80000000, 0x0,
				0x800000, 0x0, 0x100000, 0x800000, 0x0, 0x0, 0x0, 0x200000,
				0x8000000, 0x0, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x80, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0xff7ffe7c, 0x80, 0x0, 0x0, 0x0, 0x0,
				0x0, 0xff7ffe7c, 0x0, 0x0, 0x0, 0xff7ffe7c, 0xff7ffe7c, 0x0,
				0x0, 0xff7ffe7c, 0xff7ffe7c, 0xff7ffe7c, 0x0, 0x0, 0x0, 0x0,
				0xff7ffe7c, 0xff7ffe7c, 0x0, 0x0, 0x0, 0x4000, 0x0, 0x0,
				0xff7ffe7c, 0x800000, 0xff7ffe7c, 0x4000, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000,
				0xff7ffe7c, 0xff7ffe7c, 0xff7ffe7c, 0xff7ffe7c, 0xff7ffe7c,
				0xff7ffe7c, 0x0, 0x0, 0xff7ffe7c, 0x0, 0xff7ffe7c, 0x4000,
				0x4000, 0x4000, 0xff7ffe7c, 0xff7ffe7c, 0x800000, 0xff7ffe7c,
				0xff7ffe7c, 0x0, 0x800000, 0xff7ffe7c, 0xff7ffe7c, 0xff7ffe7c,
				0xff7fbe7c, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x0, 0xbfffffdb, 0xbfffffdb, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x40, 0x4, 0x0, 0x2, 0x40, 0x0, 0x0, 0x40, 0x0, 0x0,
				0xbfffffdb, 0x500, 0x500, 0x800, 0x2000, 0x40, 0x0, 0x0, 0x40,
				0x0, 0x40, 0x0, 0x40, 0x2000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xc000, 0x40, 0x0, 0x40, 0x40000, 0x2, 0x2, 0x400000, 0x800000,
				0x0, 0x0, 0x1000000, 0x0, 0x0, 0x1e000000, 0x1e000000,
				0x60000000, 0x60000000, 0x80000000, 0x80000000, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0xbfffffdb, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xbfffffdb, 0x0, 0x0, 0x0, 0xbfffffdb, 0xbfffffdb, 0x0, 0x0,
				0xbfffffc9, 0xbfffffc9, 0xbfffffc9, 0x0, 0x0, 0x0, 0x0,
				0xbfffffc9, 0xbfffffc9, 0x2000000, 0x0, 0x12, 0x0, 0x0, 0x0,
				0xbfffffdb, 0x0, 0xbfffffdb, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xbdffffc9,
				0xbfffffdb, 0xbdffffc9, 0xbfffffdb, 0xbdffffc9, 0xbfffffdb,
				0x0, 0x2000000, 0xbdffffc9, 0x2000000, 0xbdffffc9, 0x0, 0x0,
				0x0, 0xbdffffc9, 0xbdffffc9, 0x0, 0xbfffffc9, 0xbfffffc9, 0x0,
				0x0, 0xbfffffc9, 0xbfffffc9, 0xbdffffc9, 0xbdf5ffc9, };
	}

	private static void jj_la1_2() {
		jj_la1_2 = new int[] { 0x0, 0xff79fc3f, 0xff79fc3f, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xff79fc3f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7ffc0, 0x7ffc0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x2, 0x8, 0x10, 0x20, 0x0, 0x0,
				0xff79fc3f, 0x3c0, 0xfc00, 0x70000, 0x300000, 0x300000, 0x0,
				0xff79fc3f, 0x0, 0x0, 0x0, 0xff79fc3f, 0xff79fc3f, 0x0, 0x0,
				0xff79fc3f, 0xff79fc3f, 0xff79fc3f, 0x3f400000, 0x40000000,
				0x80000000, 0x80000000, 0xbf79fc3f, 0xbf79fc3f, 0x0, 0x0, 0x0,
				0x2000000, 0x0, 0x0, 0xff79fc3f, 0x0, 0xff79fc3f, 0x2000000,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x2000000, 0xbf79fc3f, 0xff79fc3f, 0xbf79fc3f,
				0xff79fc3f, 0xbf79fc3f, 0xff79fc3f, 0x0, 0x0, 0xbf79fc3f, 0x0,
				0xbf79fc3f, 0x2000000, 0x0, 0x0, 0xbf79fc3f, 0xbf79fc3f, 0x0,
				0xbf79fc3f, 0xbf79fc3f, 0x0, 0x0, 0xbf79fc3f, 0xbf79fc3f,
				0xbf79fc3f, 0xbd79fc3f, };
	}

	private static void jj_la1_3() {
		jj_la1_3 = new int[] { 0x0, 0xfcffef9f, 0xfcffef9f, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x0,
				0x0, 0x0, 0xfcffef9f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x60000000, 0x60000000,
				0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0xc000000, 0xc000000, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc000000, 0xc000000, 0xf0ffef9f,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfcffef9f, 0x0, 0x0, 0x0,
				0xf0ffef9f, 0xf0ffef9f, 0x0, 0x0, 0xf00fef1f, 0xf00fef0f,
				0xf00fef0f, 0x0, 0x0, 0x1f, 0xf, 0xf00fef0f, 0xf00fef0f, 0x0,
				0x20, 0xf00080, 0xf00, 0xf00000, 0x700000, 0xfcffef9f, 0x0,
				0xfcffef9f, 0xf00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0xf00, 0xf00fef0f, 0xfcffef9f,
				0xf00fef0f, 0xfcffef9f, 0xf00fef0f, 0xfcffef9f, 0x1000,
				0x8001000, 0xf00fef0f, 0x8001000, 0xf00fef0f, 0x78e00, 0x40000,
				0x40000, 0xf08fef0f, 0xf08fef0f, 0x0, 0xf00fef0f, 0xf00fef0f,
				0x1000, 0x0, 0xf00fef0f, 0xf00fef0f, 0xf00fef0f, 0xf008010f, };
	}

	private static void jj_la1_4() {
		jj_la1_4 = new int[] { 0x0, 0x30001, 0x30001, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x600, 0x0, 0x0, 0x600, 0x0, 0x30001,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x10000, 0x10000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x30001,
				0x10000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x30001, 0x0, 0x0, 0x1000000,
				0x30001, 0x30001, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0,
				0x1, 0x1, 0x0, 0x0, 0x0, 0x30000, 0x0, 0x0, 0x30001, 0x0,
				0x30001, 0x30000, 0x30000, 0x30000, 0x2036620, 0x0, 0x20080000,
				0x0, 0x0, 0x0, 0x0, 0x4006660, 0x4006660, 0x80066a0, 0x80066a0,
				0x500000, 0x4006620, 0x8006620, 0x2036620, 0x6620, 0x0,
				0x10000000, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x401,
				0x30001, 0x401, 0x30001, 0x401, 0x30001, 0x0, 0x0, 0x1, 0x0,
				0x1, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x1,
				0x1, 0x1, 0x1, };
	}

	private static void jj_la1_5() {
		jj_la1_5 = new int[] { 0x0, 0xc2306062, 0xc2306062, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xc2306062, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xc2306062, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0xc2306062, 0x0, 0x0,
				0x0, 0xc2006060, 0xc2306060, 0x300000, 0x300000, 0xc2000000,
				0xc2000000, 0xc2000000, 0x0, 0x0, 0x0, 0x0, 0xc2000000,
				0xc2000000, 0xc0000000, 0x0, 0x0, 0x6060, 0x0, 0x0, 0xc2306062,
				0x0, 0xc2306062, 0x6060, 0x6060, 0x0, 0x1006c60, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x8000000, 0x1000000, 0x1000000, 0x1000000,
				0x1000000, 0x0, 0x1000000, 0x1000000, 0x1006c60, 0x1000000,
				0x6000, 0x10, 0x10, 0x60, 0x0, 0x100, 0xc00, 0x200, 0x0,
				0x2000000, 0xc2306062, 0x2000000, 0xc2306062, 0x2000000,
				0xc2306062, 0x0, 0x0, 0x2000000, 0x0, 0x2000000, 0x0, 0x0, 0x0,
				0x2000000, 0x2000000, 0x0, 0x2000000, 0x2000000, 0x0, 0x0,
				0x2000000, 0x2000000, 0x2000000, 0x2000000, };
	}

	private static void jj_la1_6() {
		jj_la1_6 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x1, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x1,
